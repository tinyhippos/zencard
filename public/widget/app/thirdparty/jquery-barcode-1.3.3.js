...
$.barcode = {
	...
	digitToCss: function($container, settings, digit, hri){
		...
		var content = "";
		var bar1 = "<div style=\"float: left; background-color: " + settings.color + "; height: " + barHeight + "em; width: ";
		var bar0 = "<div style=\"float: left; background-color: " + settings.bgColor + "; height: " + barHeight + "em; width: ";
		var len = 0;
		...
		for(var i=0; i<digit.length; i++){
			if (current == digit.charAt(i)) {
                ...
                totalwidth += (len * barWidth);
				content += (current == '0' ? bar0 : bar1) + (len * barWidth) + "em\"></div>";
